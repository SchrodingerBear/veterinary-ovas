                ...
                <div class="list-group">
                    <div class="list-group-item list-group-item-action">
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox" id="category_all" value="all"
                                <?= $cid == 'all' ? "checked" : "" ?>>
                    ...
                    while ($row = $cat_qry->fetch_assoc()):
                        ...
                        <div class="list-group-item list-group-item-action">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input category-item" type="checkbox"
                                    id="category_<?= $row['id'] ?>" value="<?= $row['id'] ?>" <?= $cid == 'all' || in_array($row['id'], explode(',', $cid)) ? "checked" : "" ?>>
                                <label for="category_<?= $row['id'] ?>"
                                    class="custom-control-label"><?= $row['name'] ?></label>
                            </div>
                        </div>
                    <?php endwhile; ?>
                </div>
                ...
                <div class="list-group" id="service-list">
                    ...
                    while ($row = $services->fetch_assoc()):
                        ...
                        <div class="text-decoration-none list-group-item rounded-0 service-item">
                            <a class="d-flex w-100 text-dark align-items-center" href="#service_<?= $row['id'] ?>"
                            ...
                            <div class="collapse" id="service_<?= $row['id'] ?>">
                                ...
                                <div class="row align-items-top">
                                    ...
                                    <div class="col-2 text-right">
                                        <div class="mx-3"><span class="fa fa-tags"></span>
                                            ₱<?= number_format($row['fee'], 2) ?></div>
                                    </div>
                                </div>
